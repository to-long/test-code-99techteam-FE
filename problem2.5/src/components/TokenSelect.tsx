...
export const TokenSelect = memo(({ value, onChange, tokens, label, error, className }: TokenSelectProps) => {
  ...
  return (
    <>
      <div className={clsx("flex flex-col gap-1.5", className)}>
        ...
        {error && (
            <span className="text-xs text-red-400 ml-1 font-medium">{error}</span>
        )}
      </div>
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col items-start">
                              <span className={clsx("font-semibold text-base", isSelected ? "text-blue-400" : "text-white")}>
                                {token.currency}
                              </span>
